...
Antes de realizar la prueba de hipótesis, es importante señalar que se cuenta con la base de datos completa, la cual representa a la población en su totalidad, lo cual permite calcular directamente parámetros poblacionales como la desviación estándar del contenido de sodio, que será utilizada para aplicar la prueba mediante una distribución normal (Z), considerando que la muestra aleatoria seleccionada tiene un tamaño de 50, lo cual se considera suficientemente grande. Este enfoque es válido, ya que no es necesario estimar la variabilidad a partir de una muestra cuando se conoce la variabilidad real de toda la población.
Asimismo, se calculará la media muestral del sodio, ya que este valor es esencial para determinar el estadístico Z, el cual nos permitirá contrastar la hipótesis planteada.
